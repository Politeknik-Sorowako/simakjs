...
export class CapaianCpmkController {
  ...
  static async getRekapPerCpmk({ params, getCurrentUser }: AuthContext) {
    await getCurrentUser();
    const kelasKuliahId = parseInt(params.kelasKuliahId);
