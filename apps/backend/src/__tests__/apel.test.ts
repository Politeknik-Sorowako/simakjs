...
describe('Kelompok Apel API (Fleksibel Lintas Prodi)', () => {
  ...
  it('monitor hari ini menandai kelompok belum dibuka sebagai status belum_buka', async () => {
