...
export const dosenBody = t.Object({
  ...
  nuptk: t.Optional(t.Union([t.String(), t.Null()])),
  pohonIlmu: t.Optional(t.Union([t.String(), t.Null()])),
  cabangIlmu: t.Optional(t.Union([t.String(), t.Null()])),
...
export const updateDosenBody = t.Partial(
  t.Object({
    ...
    nuptk: t.Union([t.String(), t.Null()]),
    pohonIlmu: t.Union([t.String(), t.Null()]),
    cabangIlmu: t.Union([t.String(), t.Null()]),
    ...
    200: t.Object({
      data: t.Array(
        t.Object({
          ...
          nuptk: t.Union([t.String(), t.Null()], { default: null }),
          pohonIlmu: t.Union([t.String(), t.Null()], { default: null }),
          cabangIlmu: t.Union([t.String(), t.Null()], { default: null }),
          nik: t.Union([t.String(), t.Null()], { default: '1234567890123456' }),
          jenisKelamin: t.Union([t.String(), t.Null()], { default: 'L' }),
          tanggalLahir: t.Union([t.String(), t.Null()], { default: null }),
