...
export const updateYudisiumStatusBody = t.Object({
  status: t.Union([t.Literal('diajukan'), t.Literal('diverifikasi'), t.Literal('disetujui'), t.Literal('ditolak')]),
...
export const saveKomponenBody = t.Object({
  ...
  komponenList: t.Array(
    t.Object({
      ...
      bobot: t.Number({ minimum: 1, maximum: 100 }),
    }),
  ),
});
  ...
  response: {
    200: t.Array(
      t.Object({
        ...
        bobot: t.Optional(t.Number({ default: 30 })),
      }),
    ),
  },
};
  ...
  response: {
    200: t.Array(
      t.Object({
        ...
        bobot: t.Optional(t.Number({ default: 20 })),
