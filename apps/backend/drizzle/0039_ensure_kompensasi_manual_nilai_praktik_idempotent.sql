...
-- Ensures the kompensasi_manual and nilai_praktik tables (and their constraints
-- / indexes) exist even if the original migration 0034 was silently skipped by
-- the safe-migrate reconcile logic. All statements are idempotent / guarded so
