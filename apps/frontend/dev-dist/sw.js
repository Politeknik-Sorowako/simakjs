...
define(['./workbox-fdf26176'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    "url": "index.html",
    "revision": "0.9oalf4iiph8"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("index.html"), {
    allowlist: [/^\/$/],
    denylist: [/^\/api/, /^\/docs/, /^\/swagger/]
  }));
  ...
  workbox.registerRoute(({
    request,
    url
  }) => (request.destination === "script" || request.destination === "style") && !url.pathname.startsWith("/api/"), new workbox.StaleWhileRevalidate({
