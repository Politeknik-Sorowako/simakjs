  ...
  return (
    <MainLayout>
      <div class="space-y-6">
        ...
        {/* CPL-CPMK Coverage */}
        <Show when={cplCpmkCoverage() && !cplCpmkCoverage.loading}>
          {(data) => (
            <Card variant="bordered" padding="lg">
              <div class="flex items-center justify-between mb-4">
                ...
                <Badge
                  variant={
                    data().coveragePercent >= 80 ? 'success' : data().coveragePercent >= 50 ? 'warning' : 'danger'
                  }
                >
        ...
        {/* BK-MK Coverage */}
        <Show when={bkMkCoverage() && !bkMkCoverage.loading}>
          {(data) => (
            <Card variant="bordered" padding="lg">
              <div class="flex items-center justify-between mb-4">
