              ...
              >
                {(item) => (
                  <tr class="border-t border-slate-700/50 hover:bg-slate-700/30">
                    ...
                    <td class="px-4 py-3 text-slate-200 max-w-md truncate">{item.deskripsi}</td>
                    <td class="px-4 py-3 text-slate-300">{item.programStudi?.nama || '-'}</td>
                    <td class="px-4 py-3">
                    ...
                    <td class="px-4 py-3 text-slate-300">{item.urutan}</td>
                    <td class="px-4 py-3">
                      <div class="flex gap-2">
