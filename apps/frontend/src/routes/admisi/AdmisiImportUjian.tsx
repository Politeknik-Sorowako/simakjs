  ...
  return (
    <MainLayout>
      <div class="p-4 md:p-6 max-w-6xl mx-auto">
        ...
        <p class="text-sm text-secondary-500 mb-6">Pilih peserta yang sudah terverifikasi dokumennya, lalu jadwalkan ujian secara massal</p>

        <div class="flex gap-3 mb-4">
          <select value={sessionId()} onChange={(e) => { setSessionId(e.currentTarget.value); setSelected(new Set()); }}
        ...
        <Show when={sessionId()}>
          <div class="grid md:grid-cols-2 gap-6">
            ...
            <div class="bg-white dark:bg-secondary-800/40 border border-secondary-200 dark:border-secondary-700 rounded-xl p-4">
              ...
              <Show when={candidates.loading}><p class="text-xs text-secondary-400">Memuat...</p></Show>
            ...
            <div class="bg-white dark:bg-secondary-800/40 border border-secondary-200 dark:border-secondary-700 rounded-xl p-4">
              ...
              <div class="space-y-3">
                <div>
                  ...
                  <select value={tipeUjian()} onChange={(e) => setTipeUjian(e.currentTarget.value)}
                ...
                <div>
                  ...
                  <input type="date" required value={tanggal()} onInput={(e) => setTanggal(e.currentTarget.value)}
                    class="w-full px-2 py-1.5 border border-secondary-300 rounded text-sm bg-white dark:bg-secondary-800" />
                </div>
                <div class="grid grid-cols-2 gap-2">
                  <div>
                    <label class="text-xs font-medium block mb-0.5">Jam Mulai</label>
                    <input type="time" required value={waktuMulai()} onInput={(e) => setWaktuMulai(e.currentTarget.value)}
                      class="w-full px-2 py-1.5 border border-secondary-300 rounded text-sm bg-white dark:bg-secondary-800" />
                  </div>
                  <div>
                    <label class="text-xs font-medium block mb-0.5">Jam Selesai</label>
                    <input type="time" value={waktuSelesai()} onInput={(e) => setWaktuSelesai(e.currentTarget.value)}
                      class="w-full px-2 py-1.5 border border-secondary-300 rounded text-sm bg-white dark:bg-secondary-800" />
                  </div>
                </div>
                <div>
                  <label class="text-xs font-medium block mb-0.5">Lokasi</label>
                  <select value={lokasiType()} onChange={(e) => setLokasiType(e.currentTarget.value)}
                    class="w-full px-2 py-1.5 border border-secondary-300 rounded text-sm bg-white dark:bg-secondary-800">
                ...
                <div>
                  ...
                  <input value={lokasiDetail()} onInput={(e) => setLokasiDetail(e.currentTarget.value)}
                    class="w-full px-2 py-1.5 border border-secondary-300 rounded text-sm bg-white dark:bg-secondary-800"
