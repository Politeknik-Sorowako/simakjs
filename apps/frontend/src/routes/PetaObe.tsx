                        ...
                        <For each={data().matriks}>
                          {(row) => (
                            <tr class="border-b border-slate-700/50">
                              <td class="py-3 px-2 text-slate-900 dark:text-white font-medium">{row.cpl.kode}</td>
                    ...
                    <table class="w-full text-sm">
                      ...
                      <tbody>
                        <For each={data().matriks}>
                          {(row) => (
                            <tr class="border-b border-slate-700/50">
                              <td class="py-3 px-2 text-slate-900 dark:text-white font-medium">{row.bk.kode}</td>
                          ...
                          <table class="w-full text-sm">
                            ...
                            <tbody>
                              ...
                              >
                                {(m) => (
                                  <tr class="border-b border-slate-700/50">
                                    <td class="py-2 px-2 text-slate-900 dark:text-white font-medium">{m.kode}</td>
                                    <td class="py-2 px-2 text-slate-700 dark:text-slate-300 max-w-xs truncate">{m.deskripsi}</td>
                                    <td class="py-2 px-2 text-slate-700 dark:text-slate-300">{m.mataKuliah?.nama || '-'}</td>
                                    <td class="py-2 px-2 text-center text-slate-700 dark:text-slate-300">
