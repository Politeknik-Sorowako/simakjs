  ...
  return (
    <MainLayout>
      <div class="p-4 md:p-6 max-w-2xl mx-auto">
        ...
        <Show
          when={
            app() && app()!.status !== 'passed' && app()!.status !== 're_registration' && app()!.status !== 'nim_issued'
          }
        >
        ...
        <Show
          when={
            app() &&
            (app()!.status === 'passed' || app()!.status === 're_registration' || app()!.status === 'nim_issued')
          }
        >
          <form
          ...
          >
            ...
            <Show when={app()!.status !== 'nim_issued'}>
              ...
              />
              <Input label="Bank Asal" value={bankAsal()} onInput={(e) => setBankAsal(e.currentTarget.value)} />
              <Input
                label="Nama Pengirim"
                value={namaPengirim()}
