      ...
      <div class="flex flex-col gap-8 text-secondary-800 dark:text-white transition-colors duration-200">
        ...
        <Show when={user()?.role === 'admin'}>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Prodi Card */}
            <div class="bg-white dark:bg-secondary-900 border border-secondary-100 dark:border-secondary-800 p-6 rounded-2xl shadow-sm flex items-center justify-between transition-colors duration-200">
              <div class="flex flex-col gap-1">
                <span class="text-sm font-semibold text-secondary-400 dark:text-secondary-200 uppercase tracking-wider">
                  Program Studi
                </span>
        ...
        <Show when={user()?.role === 'dosen'}>
          {/* Dosen Portal */}
          <div class="bg-white dark:bg-secondary-900 border border-secondary-100 dark:border-secondary-800 rounded-2xl p-6 shadow-sm flex flex-col gap-4 transition-colors duration-200">
            <h3 class="text-lg font-bold border-b border-secondary-100 dark:border-secondary-800 pb-2">Informasi Mengajar</h3>
        ...
        <Show when={user()?.role === 'mahasiswa'}>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-white dark:bg-secondary-900 border border-secondary-100 dark:border-secondary-800 rounded-2xl p-6 shadow-sm flex flex-col gap-4 transition-colors duration-200">
              <h3 class="text-lg font-bold border-b border-secondary-100 dark:border-secondary-800 pb-2">Kartu Rencana Studi</h3>
              <p class="text-xs text-secondary-500 dark:text-secondary-200 mt-2">
                Silakan akses halaman <strong>KRS</strong> untuk melakukan pengisian Kartu Rencana Studi semester
                berjalan.
              </p>
            </div>
            <div class="bg-white dark:bg-secondary-900 border border-secondary-100 dark:border-secondary-800 rounded-2xl p-6 shadow-sm flex flex-col gap-4 transition-colors duration-200">
              <h3 class="text-lg font-bold border-b border-secondary-100 dark:border-secondary-800 pb-2">
                Indeks Prestasi Kumulatif (IPK)
              </h3>
              <div class="flex items-center gap-4 mt-2">
                <span class="text-4xl font-extrabold text-brand-600 dark:text-brand-400">3.85</span>
                <span class="text-xs text-secondary-400 dark:text-secondary-200 font-semibold uppercase tracking-wider">
                  IPK Sementara (OBE)
                </span>
              </div>
            </div>
            <div class="bg-white dark:bg-secondary-900 border border-secondary-100 dark:border-secondary-800 rounded-2xl p-6 shadow-sm flex flex-col gap-4 transition-colors duration-200">
              <h3 class="text-lg font-bold border-b border-secondary-100 dark:border-secondary-800 pb-2">Jam Kompensasi</h3>
              <div class="flex items-center gap-4 mt-2">
                <span
              ...
              <p class="text-[10px] text-secondary-400 dark:text-secondary-200 mt-1">
