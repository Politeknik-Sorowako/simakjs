  ...
  return (
    <MainLayout>
      <div class="flex flex-col gap-6">
        <div>
          <h1 class="text-2xl font-bold text-brand-gray-800">Laporan Jam Kompensasi</h1>
          <p class="text-sm text-brand-gray-500">Pantau dan kelola tanggungan jam kompensasi (Disiplin Vokasi) mahasiswa</p>
        </div>

        {/* Filters */}
        <div class="bg-white border border-brand-gray-100 p-6 rounded-2xl shadow-sm flex items-center justify-between gap-4">
          <div class="relative w-80">
            <span class="absolute left-3.5 top-2.5 text-brand-gray-400">🔍</span>
            <input
              type="text"
        ...
        {/* Laporan Table */}
        <div class="bg-white border border-brand-gray-100 rounded-2xl shadow-sm overflow-hidden">
            ...
            <table class="w-full text-left text-sm border-collapse">
              ...
              <tbody>
                <Show
                  ...
                  fallback={
                    <tr>
                      <td colspan="6" class="text-center py-12 text-brand-gray-400">
                        Memuat data laporan...
                      </td>
                    </tr>
                  }
            ...
            <div class="flex flex-col gap-6 max-h-[80vh] overflow-y-auto pr-2">
              ...
              <div class="bg-brand-gray-50 rounded-2xl p-5 border border-brand-gray-100 flex items-center justify-between">
                ...
                <div class="text-right">
                  <div class="text-xs text-brand-gray-400 uppercase font-semibold">Sisa Tanggungan</div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="flex flex-col gap-3">
                  <h4 class="font-bold text-brand-gray-700 border-b pb-2 text-sm">Log Akumulasi Absensi</h4>
                  <div class="flex flex-col gap-2 max-h-60 overflow-y-auto">
                    <For
                      each={detail().historyKompensasi}
                      fallback={<p class="text-xs text-brand-gray-400 italic">Tidak ada log absensi bermasalah.</p>}
                    >
                      {(log) => (
                ...
                <div class="flex flex-col gap-3">
                  <div class="flex justify-between items-center border-b pb-2">
                    <h4 class="font-bold text-brand-gray-700 text-sm">Log Penyelesaian Kompensasi</h4>
                  ...
                  <div class="flex flex-col gap-2 max-h-60 overflow-y-auto">
                    ...
                    >
                      {(pay) => (
                        <div class="bg-white border border-brand-gray-100 rounded-xl p-3 shadow-xs text-xs flex justify-between items-center">
                          <div class="flex flex-col gap-0.5">
                            <span class="font-bold text-brand-gray-700">{pay.keterangan}</span>
