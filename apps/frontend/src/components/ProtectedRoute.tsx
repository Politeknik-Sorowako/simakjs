...
export function ProtectedRoute(props: ProtectedRouteProps) {
  ...
  return (
    <Show
      when={hasAccess()}
      fallback={
        <div class="flex flex-col items-center justify-center min-h-[50vh] text-center p-6 bg-white rounded-2xl border border-gray-100 shadow-md">
          ...
          <p class="text-gray-500 mb-4">Anda tidak memiliki hak untuk mengakses halaman ini.</p>
          <button
