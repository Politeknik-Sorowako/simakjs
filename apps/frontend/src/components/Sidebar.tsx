  ...
  return (
    ...
    >
      ...
      <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
        <div class="px-3 mb-2 text-[10px] font-semibold text-gray-500 uppercase tracking-widest">Menu Utama</div>
        ...
        <div class="flex items-center gap-3">
          ...
          >
            <img
              ...
              alt="Foto Profil"
              class="h-9 w-9 rounded-full object-cover border border-slate-700 shadow-md"
            />
          </Show>
