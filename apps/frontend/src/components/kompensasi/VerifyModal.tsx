  ...
  const handleSubmit = async () => {
    ...
    try {
      await presensiController.verifikasiUnknown({
        ...
        statusKonfirmasi: status() as 'SAKIT' | 'IZIN' | 'ALPA' | 'TERLAMBAT' | 'HADIR',
        durasiMenit: durasi(),
        ...
        {(row) => (
          <div class="flex flex-col gap-4">
            ...
            <p class="text-xs text-secondary-400 dark:text-secondary-300">
              Pilih <b>Hadir</b> untuk menganulir (durasi 0) atau pilih status lain untuk mengkonfirmasi ketidakhadiran.
            </p>
